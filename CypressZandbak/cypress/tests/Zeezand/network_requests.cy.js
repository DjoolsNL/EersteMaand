...
context("Network Requests", () => {
    ...
    it("cy.request() - make an XHR request", () => {
        // Meer info: https://on.cypress.io/request
    ...
    it("cy.request() with query parameters", () => {
        ...
        // Meer info: https://jsonplaceholder.cypress.io/comments?postId=1&id=3
        cy.request({
    ...
    it("cy.request() - save response in the shared test context", () => {
        // Meer info: https://on.cypress.io/variables-and-aliases
        cy.request("https://jsonplaceholder.cypress.io/users?_limit=1")
            .its("body")
            .its("0") // yields the first element of the returned list
    ...
    it("cy.intercept() - route responses to matching requests", () => {
        // Meer info: https://on.cypress.io/intercept
        ...
        // Meer info: https://on.cypress.io/wait
        cy.wait("@getComment")
